...
public class ToastUtil {
    ...
    public static void showTextToast(@NonNull String msg) {
        try {
            if (!TextUtils.isEmpty(msg) && !msg.equals("null")) {
                ...
                mToast = Toast.makeText(CustomApp.getInstance(), msg + "", Toast.LENGTH_LONG);
                mToast.show();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void showTextToast(@StringRes int stringId) {
        try {
            ...
            mToast = Toast.makeText(CustomApp.getInstance(), CommonUtil.getStringResources(stringId) + "", Toast.LENGTH_LONG);
            mToast.show();
        } catch (Exception e) {
            e.printStackTrace();
        }
